#if defined(_WIN32) && defined(SK_DEV)
/**********************************************************************
 * 
 * StackWalker.cpp
 *
...
StackWalker::Trace* StackWalker::GetCallStack(HANDLE hThread, const CONTEXT *context, PReadProcessMemoryRoutine readMemoryFunction, LPVOID pUserData)
{
	CONTEXT c;;
...
#error "Platform not supported!"
	...
	for (frameNum = 0; ; ++frameNum )
	{
		...
		CallstackEntry& csEntry = currentEntry->entry;
